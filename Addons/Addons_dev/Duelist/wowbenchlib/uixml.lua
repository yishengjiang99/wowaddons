...
WOWB_XMLTagInfo = {
	...
	OnDragStart = { script=1 }, OnDragStop = { script=1 },
	...
	OnHide = { script=1 }, OnHyperlinkClick = { script=1 },
	OnInputLanguageChanged = { script=1 },
	OnKeyDown = { script=1 }, OnKeyUp = { script=1 },
	OnLeave = { script=1 },OnLoad = { script=1 },
	OnMouseDown = { script=1 }, OnMouseUp = { script=1 }, OnMouseWheel = { script=1 },
...
for k,_ in {
	...
	if not WOWB_XMLTagInfo[k] then
		WOWB_XMLTagInfo[k] = { attribute=1 }
	end
end
