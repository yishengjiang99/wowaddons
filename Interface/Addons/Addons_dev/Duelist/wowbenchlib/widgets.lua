...
function WBClass_FontInstance:GetFont() -- Return the font file, height, and flags for this FontInstance. 
	return self[0].fontName, self[0].fontHeight, self[0].fontFlags
end
function WBClass_FontInstance:GetFontObject() _notimplemented("FontInstance.GetFontObject"); end -- Return the 'parent' FontInstance object, or nil if none. 
...
function WBClass_FontInstance:SetFontObject(fontObject) _notimplemented("FontInstance.SetFontObject"); end -- Sets the 'parent' FontInstance object. 
...
function WBClass_Frame:CreateFontString(strName,strLayer) -- Create and return a new FontString as a child of this Frame. 
	return CreateFrame("FontString",strName,self);  -- TODO: move to internal function, e.g. WOWB_CreateRegion. CreateFrame shouldn't be able to create these.
end
function WBClass_Frame:CreateTexture(strName,strLayer) -- Create and return a new Texture as a child of this Frame. 
	return CreateFrame("Texture",strName,self);   -- TODO: move to internal function, e.g. WOWB_CreateRegion. CreateFrame shouldn't be able to create these.
end
...
function WBClass_Frame:HasScript(strHandler) _notimplemented("Frame.HasScript"); end -- Return true if the frame can be given a handler of the specified type  = function(self, NOT whether it actually HAS one, use GetScript for that) assert(false); end -- Since 1.8. 
...
function WBClass_Frame:SetClampedToScreen(clamped) _notimplemented("Frame:SetClampedToScreen"); end -- Set whether the frame is prohibited from being dragged off screen - New in 1.11.
...
function WBClass_Frame:SetMovable(isMovable) _notimplemented("Frame.SetMovable"); end -- Set whether the frame can be moved. 
...
function WBClass_Frame:SetToplevel(isToplevel) _notimplemented("Frame.SetToplevel"); end -- Set whether the frame is Toplevel. 
...
function WBClass_LayeredRegion:SetDrawLayer(strLayer) _notimplemented("LayeredRegion.SetDrawLayer"); end -- Sets the draw layer for the LayeredRegion
...
function WBClass_Button:GetTextFontObject() _notimplemented("Button.GetTextFontObject"); end -- Return the font object for the Button's normal text - New in 1.10. 
...
function WBClass_Button:SetTextFontObject(font) _notimplemented("Button.SetTextFontObject"); end -- Set the font object from which to get settings for this Button's normal state - New in 1.10. 
...
function WBClass_MessageFrame:AddMessage(strText,   r,g,b,a,holdTime) _notimplemented("MessageFrame:AddMessage"); end -- Add a message to the frame which will fade eventually. 
...
function WBClass_MessageFrame:SetInsertMode(strTopOrBottom) _notimplemented("MessageFrame:SetInsertMode"); end -- Set where new messages are inserted ("TOP or "BOTTOM") - New in 1.11. 
...
function WBClass_Slider:SetOrientation(str) _notimplemented("Slider.SetOrientation"); end
function WBClass_Slider:SetThumbTexture(--[[UNKNOWN]]) _notimplemented("Slider.SetThumbTexture"); end  -- Get the texture for this slider's thumb - New in 1.11.
...
function WBClass_Slider:SetThumbTexture(oTexture)  _ignore_notimplemented("Slider.SetThumbTexture"); end
...
function WBClass_CheckButton:SetChecked(bState) -- Set the status of the checkbox. 
...
function WBClass_Texture:SetTexture(r,g,b) -- Sets the texture to be displayed ("texturePath" or r,g,b)
	if(not g) then
