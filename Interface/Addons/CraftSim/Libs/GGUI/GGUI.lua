...
function GGUI.Text:new(options)
    ...
    if options.fontOptions then
        SetFontIfAvailable(text, options.fontOptions.fontFile, options.fontOptions.height or 20,
            options.fontOptions.flags)
    end
...
function GGUI.Button:new(options)
    ...
    if options.fontOptions then
        ...
        if fontString then
            SetFontIfAvailable(fontString, options.fontOptions.fontFile, options.fontOptions.height or 12,
                options.fontOptions.flags)
        end
    end
